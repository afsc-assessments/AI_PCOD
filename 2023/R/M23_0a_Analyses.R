...
DatM23_0a$catch[34,4]=7898 #Estimated catch through end of year.
...
CtlM23_0a$MG_parms[4,9:14]=c(0,0,0,5,1,1)#just K. #is first one time varying?
...
CtlM23_0a$size_selex_parms[,1]=c(60,-20,-10,-10,-1000,-10,10,-20,-10,0,-12,-10)
CtlM23_0a$size_selex_parms[,2]=c(100,10,10,10,2.71828,10,90,10,10,10,2.71828,10)
CtlM23_0a$size_selex_parms[,3]=c(98,25,6.7303,-0.838869,-999,4,58.4071,-3.05,5.71361,3.98,-2.35,10)
CtlM23_0a$size_selex_parms[,4]=c(98,25,3,10,-999,4,58.1,-3.05,5.76,3.98,-2.35,10)
CtlM23_0a$size_selex_parms[,5]=0.001
CtlM23_0a$size_selex_parms[1,5:6]=c(1,6)
...
CtlM23_0a$recdev_early_start=1981
...
copy_SS_inputs(
  dir.old = Dir_M23_0a,
  dir.new = Dir_M23_0ar,overwrite=TRUE
)

run(dir=Dir_M23_0ar,exe=Exe_path,
    skipfinished=FALSE,
